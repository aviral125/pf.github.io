...
$('.nav-lists').on('click', 'div', function() {
    $('.nav-lists div.acti').removeClass('acti');
    $(this).addClass('acti');
...
$('#exp').click(function() {
    	...
    	// console.log("roit");
    	$('.isexpert').css("display","block");

    $('.isintermediate').css("display","none");
    $('.isnew').css("display","none");
 $('.isexpert').slick({
   lazyload:'ondemand',
    centerMode: false,
  slidesToShow: 1.6,
...
$('#int').click(function() {
    	...
    	$('.isintermediate').css("display","block");
   		$('.isexpert').css("display","none");
   		$('.isnew').css("display","none");

$('.isintermediate').slick({
    centerMode: false,
  slidesToShow: 1.6,
  dots: true,
  infinite: false,
